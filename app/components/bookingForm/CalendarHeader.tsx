...
export function CalendarHeader({state, calendarProps, prevButtonProps, nextButtonProps}: {
  ...
  // Formatter of the calendar header to get "day, month, year"
  ...
  // formatToParts makes the single parts display. then it maps over it
  ...
  return(
    <div className="flex items-center pb-4">
      ...
      <h2 className="font-semibold flex-1 pl-3">
